...
elif [ "$model" = "grcn" ]; then
    CUBLAS_WORKSPACE_CONFIG=:4096:8 python run_multimodal.py --dataset ${dataset} --model grcn --method zeros > grcn_${dataset}_zeros.out 2>&1
    CUBLAS_WORKSPACE_CONFIG=:4096:8 python run_multimodal.py --dataset ${dataset} --model grcn --method random > grcn_${dataset}_random.out 2>&1
    CUBLAS_WORKSPACE_CONFIG=:4096:8 python run_multimodal.py --dataset ${dataset} --model grcn --method mean > grcn_${dataset}_mean.out 2>&1
