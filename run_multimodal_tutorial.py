...
if args.method == 'heat':
    ...
    """
      ...
      models:
        ...
        config = f"""experiment:
      backend: pytorch
      path_output_rec_result: ./results/{args.data}/feat_prop_{args.layers}_{args.top_k}/folder/recs/
      path_output_rec_weight: ./results/{args.data}/feat_prop_{args.layers}_{args.top_k}/folder/weights/
      path_output_rec_performance: ./results/{args.data}/feat_prop_{args.layers}_{args.top_k}/folder/performance/
      data_config:
        strategy: fixed
        train_path: ../data/{args.data}/train_indexed.tsv
        validation_path: ../data/{args.data}/val_indexed.tsv
    ...
    """
      ...
      models:
        ...
        config = f"""experiment:
      backend: pytorch
      path_output_rec_result: ./results/{args.data}/pers_page_rank_{args.layers}_{args.top_k}_{args.a}/folder/recs/
      path_output_rec_weight: ./results/{args.data}/pers_page_rank_{args.layers}_{args.top_k}_{args.a}/folder/weights/
      path_output_rec_performance: ./results/{args.data}/pers_page_rank_{args.layers}_{args.top_k}_{args.a}/folder/performance/
      data_config:
        strategy: fixed
        train_path: ../data/{args.data}/train_indexed.tsv
        validation_path: ../data/{args.data}/val_indexed.tsv
