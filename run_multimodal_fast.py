...
best_lr = dictionary[args.dataset][args.model]['lr']
best_l_w = dictionary[args.dataset][args.model]['l_w']
...
if args.method == 'feat_prop':
    ...
    with open(f'./config_files/{args.model}_pers_page_rank_{args.layers}_{args.top_k}_{args.a}_{args.dataset}.yml',
              'w') as f:
        f.write(config.format(args.dataset).replace('dataset_name', args.dataset))
