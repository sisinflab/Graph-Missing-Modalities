...
def main():
    ...
    if not os.path.exists(logs_path + f'/{args.data}/mean_neigh/{args.model}/'):
    ...
    for hyperparam in hyperparams:
        ...
        completed = False
        if os.path.isfile(f'{logs_path}/{args.data}/mean_neigh/{args.model}/{logfile}'):
            with open(f'{logs_path}/{args.data}/mean_neigh/{args.model}/{logfile}', 'r', encoding='utf-8', errors='ignore') as f:
                content = f.read()
